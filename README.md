...
![alt tag](https://github.com/Nayonex/MarcTest/FlappyLearning/blob/gh-pages/img/flappy.png?raw=true)

### [NeuroEvolution.js](http://github.com/Nayonex/MarcTest/FlappyLearning/blob/gh-pages/Neuroevolution.js) : Utilization
```javascript
// Initialize
...
You can see the NeuroEvolution integration in Flappy Bird in [Game.js](http://github.com/Nayonex/MarcTest/FlappyLearning/blob/gh-pages/game.js).
